...
// miembro más antiguo. Utiliza este array para probar tu función.
...
const xMen = [
  ...
  function findOldestXMen(xMen) {
    let oldest = xMen[0]; //Asumimos que el primero es el mas antiguo.
    for(let i = 0; i < xMen.length; i++){ //Recorremos el array.
